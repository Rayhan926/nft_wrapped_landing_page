...
const WrappedNFTAndLeaderboardPassBundleCard = () => {
  return (
    <div className="__price_card bg-[url('/img/leaderboard_pass_bg.svg')] bg-[#F6F6F6]">
      ...
      >
        Wrapped NFT & Leaderboard Pass Bundle
      </h3>

      <p className="text-black/80 __price_card_body_text max-w-[200px]">
        Bundle your Wrapped & Leaderboard Pass to save!
      </p>
      ...
      <div className="mt-auto w-full">
        <button
          ...
          className="font-bold text-center rounded-full w-full max-w-[295px] py-[17.5px] "
        >
          Buy Now
        </button>
...
export default WrappedNFTAndLeaderboardPassBundleCard;
